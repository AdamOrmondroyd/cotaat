"""
Power spectrum using a vanilla linf, with 4 nodes.
"""
...
def vanilla_4_power_spectrum(
    ...
    """
    Creates the primordial scalar power spectrum as exp(linf) with 4 nodes.
    ...
    theta = np.array([lnP0, lgk1, lnP1, lgk2, lnP2, lnP3])
    # print(theta)
...
class Vanilla4PrimordialPk(Theory):
    """
    ...
    def calculate(self, state, want_derived=True, **params_values_dict):
        ...
        ks, Pks = vanilla_4_power_spectrum(
            lnP0,
            lnP1,
            lnP2,
            lnP3,
