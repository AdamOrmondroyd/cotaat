"""
Power spectrum using a vanilla linf, with 1 node.
"""
...
def vanilla_1_power_spectrum(
    ...
    """
    Creates the primordial scalar power spectrum as exp(linf) with 1 node.
...
class Vanilla1PrimordialPk(Theory):
    """
    ...
    def calculate(self, state, want_derived=True, **params_values_dict):
        ...
        (lnP3,) = [params_values_dict[p] for p in self.params.keys()]
        ks, Pks = vanilla_1_power_spectrum(
            lnP3,
            num_ks=self.num_ks,
        )
